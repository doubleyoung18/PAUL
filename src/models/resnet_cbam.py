...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, last_stride=1, is_for_test=False, norm=False):
        self.inplanes = 64
...
def resnet50_cbam(pretrained=True, remove=False, param_path='../../imagenet_models/RESNET50_CBAM.pth', **kwargs):
